...
import { GrammaticalCategory } from '@/types/phrases';
...
const MYMEMORY_EMAIL = import.meta.env.VITE_MYMEMORY_EMAIL || 'dangarzon2003@gmail.com';
        ...
        meaning.definitions.forEach(def => {
          ...
          if (def.example) {
            result.examples.push({
              ...
              translation: '', // Could translate this too, but would use more quota
            });
          }
...
/**
 * Extract unique words from a list of phrases
 */
export const extractUniqueWords = (phrases: string[]): string[] => {
